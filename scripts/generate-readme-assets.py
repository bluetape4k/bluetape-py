...
def defs() -> str:
  ...
  <defs>
    ...
    <marker id="arrow" markerWidth="14" markerHeight="14" refX="12" refY="7"
      orient="auto" markerUnits="userSpaceOnUse" data-role="primary"
      data-tip-direction="positive-x">
      <path d="M 2 2 L 12 7 L 2 12 Z" fill="#57708F" stroke="#57708F"
        stroke-width="0" stroke-dasharray="none"/>
    </marker>
    <marker id="arrow-soft" markerWidth="10" markerHeight="10" refX="8" refY="5"
      orient="auto" markerUnits="userSpaceOnUse" data-role="secondary"
      data-tip-direction="positive-x">
      <path d="M 2 2 L 8 5 L 2 8 Z" fill="#8A9BB0" stroke="#8A9BB0"
        stroke-width="0" stroke-dasharray="none"/>
    </marker>
  </defs>
"""
