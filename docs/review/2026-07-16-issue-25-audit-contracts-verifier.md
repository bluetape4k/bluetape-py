...
| Equal-or-stricter explicit validation returns the same event | `_validation.py` fixed ordered checks | all twelve limits at boundary/limit+1, total precedence, same-object success | Mapped |
