...
표준 라이브러리만 사용하며 runtime dimension을 검사하는 불변 선형 측정값입니다.
...
Built-in 집합은 meter, kilometer, centimeter, millimeter, second, millisecond,
...
Application이 custom unit 정의를 소유하고 동일한 bounded, duplicate-free unit
...
Compound unit, dimensional-expression parsing, affine temperature conversion,
